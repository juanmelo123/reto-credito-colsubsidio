...
export const LOTE_DEMO: RegistroEntrada[] = [
  ...
  { cedula: "7974362414", nombre: "Andrés Muñoz Gutiérrez", categoriaAfiliacion: "A" },
  { cedula: "2093713454" },
  { cedula: "1514781989" },
  ...
  { cedula: "1110305764" },
  { cedula: "4237493136", direccion: "Carrera 43A # 7-50, Medellín" },
  { cedula: "1086230783" },
  { cedula: "7438617296" },
  { cedula: "28044732", nombre: "Claudia Gloria Herrera Suárez", correo: "cherrera52@gmail.com" },

  // Hipotecario: ticket alto, 180 meses, respaldo y horizonte laboral.
  { cedula: "15148524", nombre: "Ángela Adriana Rojas Suárez", categoriaAfiliacion: "B" },
  { cedula: "6694033367" },
  { cedula: "2759845556" },
  { cedula: "1012628603", direccion: "Calle 93 # 15-20, Bogotá" },

  // Educativo: la senal es la etapa formativa.
  { cedula: "51163069" },
  { cedula: "8990664204" },
  { cedula: "16995740" },
  { cedula: "2502800909", nombre: "Sergio Castañeda Vargas" },
  { cedula: "5783764830" },
  { cedula: "96698784" },
  ...
  { cedula: "15513482" },
  { cedula: "3235666525", nombre: "Andrés Rodríguez Cortés", categoriaAfiliacion: "C" },
  { cedula: "3106003838" },
  ...
  { cedula: "2082640782" },
  { cedula: "1770994988" },
  { cedula: "8139539938", nombre: "María Jiménez Medina" },
  { cedula: "8118886664" },
  ...
  { cedula: "11601047" },
  { cedula: "5243793366" },
  { cedula: "7537381753", nombre: "Natalia Paula Suárez Suárez" },
...
export const CASOS_INDIVIDUALES: Array<{ cedula: string; titulo: string }> = [
  ...
  { cedula: "4587361827", titulo: "Crédito Mujer: cumple los 7 criterios" },
  { cedula: "8118886664", titulo: "Ingreso de 1 SMMLV: tope de $1.500.000" },
  { cedula: "51163069", titulo: "19 años: crédito educativo" },
  { cedula: "4988327556", titulo: "No elegible: mora vigente" },
  { cedula: "62207269", titulo: "No afiliado (categoría D): oferta limitada" },
];
...
export function loteDemoComoCsv(): string {
  ...
  return ["cédula,nombre,correo,dirección,categoría", ...filas].join("\n");
}
